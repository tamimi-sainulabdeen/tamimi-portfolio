      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {project.tags.map((tag) => (
            <motion.span
              key={tag}
              className="text-xs px-2.5 py-1 rounded-lg bg-gradient-to-r from-primary/20 to-secondary/20 border border-primary/30 text-foreground text-sm hover:from-primary/20 hover:to-secondary/20 transition-all duration-300"
...
export function Projects() {
  // Get all projects directly from the registry
  ...
  return (
    <section id='projects' className="py-20 px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Projects Grid - Simplified without tabs */}
        <motion.div
